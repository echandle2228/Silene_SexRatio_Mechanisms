...
(fruit_plot2 <- ggplot(data = Micro_figure, 
...
```{r}
(PolExp_plot <- ggarrange(fruit_plot1, vs_plot, nrow = 2, ncol = 1, labels = c("A", "B")))

ggsave(filename = "Figures/PolExp_MainFigure.png", dpi = 300)
