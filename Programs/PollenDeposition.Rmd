...
### All together
```{r}
qA_ovule_all.m <- glmer.nb(Ovule_Number_1 ~ Sex * Stigma_Length + Population + (1|Plant.ID), data = stigma_all, verbose = TRUE)
...
###### Do I include micro sex ratio considering the pollination experiment results?
q1_ovule_binom.m <- glmer(female_func ~ Sex * Stigma_Length + Herm_Count + Fem_Count + Population + (1|Plant.ID), data = stigma_all, family = "binomial")

summary(q1_ovule_binom.m)
Anova(q1_ovule_binom.m)

RE_ovule_binom.m <- glm(female_func ~ Sex * Stigma_Length + Population, data = stigma_all, family = "binomial")
...
(ov_plot1 <- ggplot(stigma_all, aes(x = Stigma_Length, y = female_func)) +  
...
q1_ovule_num.m <- glmer.nb(Ovule_Number_1 ~ Sex * Stigma_Length + Population + (1|Plant.ID), data = ovule1, verbose = TRUE)
